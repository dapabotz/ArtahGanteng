...
- Tanggal : ${calender}`
if (modelmenu == 'butloc'){
sendButLocation(from, `${menu}`, `${uwu}*© ArtahZyx*${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU📒'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER👤'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT🌹'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
}
 else if (modelmenu == 'butlist'){
 	listMsg = {
 buttonText: 'LIST MENU',
 footerText: '*_© ArtahZyx_*',
 description: `${menu}`,
 sections: [
                     {
...
${uwu}`
       const fduct = {
					"productMessage": {
						...
						"businessOwnerJid": "62895378264836@s.whatsapp.net"
					}
				}
